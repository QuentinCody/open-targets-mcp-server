...
// src/index.ts
var OPEN_TARGETS_GRAPHQL_ENDPOINT = "https://api.platform.opentargets.org/api/v4/graphql";
...
Refer to Open Targets Platform documentation: https://platform.opentargets.org/data-and-code-access and their GraphQL API info: https://platform.opentargets.org/data-code-access/graphql-api`,
      capabilities: {
        tools: {}
        // Indicates tool support. The tool itself is registered in init().
      }
    });
  }
  static {
...
- If your queries fail, the first step should be to use introspection to verify your query structure, field names, and types against the live API schema.`,
  ...
  async executeOpenTargetsGraphQLQuery(query, variables) {
    try {
      const headers = {
          ...
          errors: [
            {
              ...
              extensions: {
                ...
                responseText: responseBodyText.substring(0, 1e3)
          ...
          errors: [
            {
              ...
              extensions: {
                statusCode: response.status,
                responseText: errorTextContent.substring(0, 1e3)
              }
            }
          ]
        };
...
var src_default = {
  async fetch(request, env2, ctx) {
    ...
    if (url.pathname === "/sse" || url.pathname.startsWith("/sse/")) {
      ...
      return sseHandler.fetch(request, env2, ctx);
    }
    console.error(
...
// .wrangler/tmp/bundle-vlFp4a/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-vlFp4a/middleware-loader.entry.ts
