...
// ../.nvm/versions/node/v20.18.0/lib/node_modules/wrangler/node_modules/@cloudflare/unenv-preset/dist/runtime/node/async_hooks.mjs
...
var OpenTargetsMCP = class extends McpAgent {
  constructor() {
    super(...arguments);
...
var src_default = {
  async fetch(request, env2, ctx) {
    ...
    if (url.pathname === "/sse" || url.pathname.startsWith("/sse/")) {
      return OpenTargetsMCP.serveSSE("/sse").fetch(request, env2, ctx);
    }
    ...
    if (url.pathname === "/initialize-schema" && request.method === "POST") {
      const globalDoId = env2.JSON_TO_SQL_DO.idFromName("global-schema-config");
      const stub = env2.JSON_TO_SQL_DO.get(globalDoId);
...
// .wrangler/tmp/bundle-KpeZgl/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-KpeZgl/middleware-loader.entry.ts
